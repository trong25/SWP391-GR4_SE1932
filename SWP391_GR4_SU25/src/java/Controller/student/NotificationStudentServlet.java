...
/**
 * Servlet NotificationStudentServlet xử lý các yêu cầu HTTP để hiển thị danh
 * sách thông báo của học sinh.
 *
 * URL Mapping: /student/NotificationStudent
 *
 * Chức năng: - Kiểm tra người dùng đã đăng nhập hay chưa (lấy từ session) - Nếu
 * chưa đăng nhập, chuyển hướng sang trang đăng nhập - Nếu đã đăng nhập, gọi
 * NotificationDAO để lấy danh sách thông báo dựa trên user ID - Chuyển tiếp dữ
 * liệu thông báo đến trang listNotification.jsp để hiển thị
 *
