...
/**
 * Lớp TimeKeepTeacherServlet dùng để xử lý các yêu cầu HTTP GET liên quan đến việc hiển thị bảng chấm công của nhân sự theo tuần và năm học.
 * 
 ...
 * @version 1.0
 */
@WebServlet(name="TimeKeepTeacherServlet", urlPatterns={"/teacher/mytimekeeping"})
public class TimeKeepTeacherServlet extends HttpServlet {
