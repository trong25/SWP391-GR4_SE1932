...
// Create Timetable object
    ...
    // Lấy Timetable đầu tiên theo date_id (dùng cho EvaluationDAO)
    public Timetable getTimetableByDateId(String dateId) {
        String sql = "SELECT * FROM Timetables WHERE date_id = ?";
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
