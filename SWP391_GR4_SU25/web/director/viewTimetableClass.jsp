...
<html lang="en">
    ...
    <head>
        ...
        <title>Trung Tâm Dạy Học Thêm TaBi</title>
                                    ...
                                    <div class="class-form m-2">
                                        <label>Tuần học
                                            <select id="week" name="week" onchange="this.form.submit()" class="custom-select" ${not empty classselect ? '' : 'disabled'}>
                                                ...
                                                <c:if test="${not empty requestScope.weekList}">
                                                    <c:forEach items="${requestScope.weekList}" var="w">
                                                        <option ${sltedw eq w.getId() ? "selected" : ""} value="${w.getId()}">
                                                            ${w.getStartDatetoEndDate()}
                                                        </option>
                                                    </c:forEach>
                                                </c:if>
