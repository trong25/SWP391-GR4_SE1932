                                        ...
                                        <form action="studentprofile" method="post">
                                            ...
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><div class="form-group col-md-6">    
                                                                <h5>Họ Tên Bé:</h5> <input class="form-control-sm" type="text" name="name_student" value="${student.lastName} ${student.firstName}"  readonly="" /><br />
                                                            </div></td>
                                                        <td>
                                                            <div class="form-group col-md-8">
                                                                <h5>Ngày Sinh Của Bé:</h5><input class="form-control-sm" type="date" name="birthday" value="${student.birthday}" readonly=""/><br />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
