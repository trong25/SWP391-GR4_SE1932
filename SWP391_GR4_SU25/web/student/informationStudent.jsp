                                            ...
                                            <div class="row gutters">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" placeholder="Mã người dùng" type="text" name="userId" value="${student.userId}" disabled style="width: 32%;"/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="id">Mã Học Sinh</label>
                                                        <input class="form-control" placeholder="Mã học sinh" type="text" name="id" value="${student.id}" disabled style="width: 32%;"/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="firstName">Họ tên bố <a style="color: red">(*)</a></label>
                                                        <input style="width: 70%;" class="form-control" type="text" name="first_guardian_name" value="${student.firstGuardianName}" pattern="^[A-Za-z${vietnamesePattern}\s]{1,80}$" title="Họ và tên không được chứa số hoặc kí tự đặc biệt (Tối đa 80 kí tự)" required=""/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="phoneNumber">Số điện thoại bố <a style="color: red">(*)</a></label>
                                                        <input style="width: 50%;" type="text" class="form-control" placeholder="Số điện thoại" name="firstGuardianPhoneNumber" value="${student.firstGuardianPhoneNumber}" pattern="^(0[23578]|09)\d{8}$" title="Số điện thoại không hợp lệ vui lòng kiểm tra lại" required=""/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="firstName">Họ tên mẹ <a style="color: red">(*)</a></label>
                                                        <input style="width: 70%;" class="form-control" type="text" name="second_guardian_name" value="${student.secondGuardianName}" pattern="^[A-Za-z${vietnamesePattern}\s]{1,80}$" title="Họ và tên không được chứa số hoặc kí tự đặc biệt (Tối đa 80 kí tự)"/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="phoneNumber">Số điện thoại mẹ <a style="color: red">(*)</a></label>
                                                        <input style="width: 50%;" type="text" class="form-control" placeholder="Số điện thoại" name="secondGuardianPhoneNumber" value="${student.secondGuardianPhoneNumber}" pattern="^(0[23578]|09)\d{8}$" title="Số điện thoại không hợp lệ vui lòng kiểm tra lại"/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="lastName">Họ tên học sinh </label>
                                                        <input style="width: 50%;" type="text" class="form-control" placeholder="Họ tên học sinh" name="name_student" value="${student.lastName} ${student.firstName}" disabled/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="email">Email <a style="color: red">(*)</a></label>
                                                        <input style="width: 60%;" class="form-control" placeholder="email" type="email" name="email" value="${student.email}" required=""/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row gutters">
                                            ...
                                            <div class="row gutters">
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input style="width: 50%;" class="form-control" type="date" name="birthday" value="${student.birthday}" disabled/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" placeholder="Địa chỉ" name="address" rows="2" pattern="^[A-Za-z1-9,${vietnamesePattern}\s]{1,100}$" title="Địa chỉ không được quá 100 kí tự">${student.address}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="lastName">Tình trạng</label>
                                                        <input style="width: 50%;" class="form-control" type="text" name="status" value="${student.status}" disabled/>
                                                    </div>
                                                </div>
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="address">Ghi chú <a style="color: red">(*)</a></label>
                                                        <textarea class="form-control" placeholder="Ghi chú" name="note" rows="2">${student.parentSpecialNote}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row gutters">
