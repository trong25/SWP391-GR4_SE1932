    ...
    <html lang="en">
        ...
        <!-- Page level custom scripts -->
        <script src="https://cdn.jsdelivr.net/npm/startbootstrap-sb-admin-2@4.1.4/js/demo/chart-area-demo.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/startbootstrap-sb-admin-2@4.1.4/js/demo/chart-pie-demo.js"></script>
