                                            ...
                                            <div class="row gutters">
                                                ...
                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    ...
                                                    <div class="row gutters">
                                                           <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="form-group">
                                                        <label for="teaching_years">Số năm kinh nghiệm <a style="color: red">(*)</a></label>
                                                        <input style="width: 40%;" class="form-control" placeholder="Số năm giảng dạy" type="number" min="0" max="99"
                                                               name="teaching_years" value="${personnel.teaching_years}" title="Vui lòng nhập số năm kinh nghiệm hợp lệ (0–99)"/>
                                                    </div>
                                                </div>
